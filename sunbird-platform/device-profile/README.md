...
./run_scenario.sh /mount/data/benchmark/apache-jmeter-5.3/ 'Jmeter_Slave1_IP,Jmeter_Slave2_IP,Jmeter_Slave3_IP,Jmeter_Slave4_IP' device-profile device-profile_RunId001 5 1 5 /mount/data/benchmark/sunbird-perf-tests/sunbird-platform/device-profile/host.csv /mount/data/benchmark/sunbird-perf-tests/sunbird-platform/device-profile/ipaddress.csv /mount/data/benchmark/sunbird-perf-tests/sunbird-platform/device-profile/device_ids.csv /api/v3/device/profile
