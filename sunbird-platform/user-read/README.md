...
e.g.
./run_scenario.sh /mount/data/benchmark/apache-jmeter-5.3/ 'Jmeter_Slave1_IP,Jmeter_Slave2_IP,Jmeter_Slave3_IP,Jmeter_Slave4_IP' user-read user-read_RUNID01 10 5 10 "ABCDEFabcdef012345" abc.com  useremailid@gmail.com /mount/data/benchmark/sunbird-perf-tests/sunbird-platform/user-read/host.csv  /mount/data/benchmark/sunbird-perf-tests/sunbird-platform/user-read/userIds.csv /api/user/v2/read
